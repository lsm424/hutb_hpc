...
layout = html.Div([
    ...
    html.Div([
        ...
        html.Div(id='node-detail-panel', className="hidden bg-gray-900 border border-gray-800 rounded-xl p-6 animate-fade-in-up", style={'scroll-margin-top': '20px'}, children=[
            html.Div([
                html.H2([
...
# 注意：滚动到详情面板功能已改为使用 URL hash 锚点 (#node-detail-panel)
...
def handle_card_click(n_clicks):
    ...
    # 返回选中的节点ID和hash锚点
    return node_id, '#node-detail-panel'
